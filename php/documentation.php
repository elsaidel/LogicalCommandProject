    ...
    <div class="wrapper theme-6-active pimary-color-green">
								...
								<ul class="pa-20">
									...
									<li class="col-md-3 col-xs-6 col-menu-list">
										<a href="javascript:void(0);">
											<div class="pull-left">
												<i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Operator</span>
											</div>	
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ecom_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Operators</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
					<ul id="ecom_dr" class="collapse collapse-level-1">
						<li>
							<a href="export-table.html">Deatails of boats</a>
						</li>
						<li>
							<a href="basic-table.html">Operators</a>
						</li>
						<li>
							<a href="tinymce-wysihtml5.html">Report of Operators</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul id="app_dr" class="collapse collapse-level-1">
						<li>
							<a href="basic-table.html">Database Management</a>
						</li>
						<li>
							<a href="basic-table.html">Permissions</a>
						</li>
						<li>
							<a href="responsive-table.html">User Management</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="widgets.html"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">Statistics</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
				</li>
				...
				<li>
					...
					<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="sparkline.html">Vectors</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					<a href="documentation.html"><div class="pull-left"><i class="zmdi zmdi-book mr-20"></i><span class="right-nav-text">Documents</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
				</li>
				<li>
